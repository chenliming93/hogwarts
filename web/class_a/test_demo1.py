...
class TestTestdemo():
    ...
    def test_shelvc(self):
        ...
        # 上传
        self.driver.find_element(By.CSS_SELECTOR,'.ww_fileImporter_fileContainer_uploadInputMask').send_keys(r'F:\aa.xlsx')
        filename = self.driver.find_element(By.CSS_SELECTOR,'.ww_fileImporter_fileContainer_fileNames').text

        assert 'aa.xlsx' == filename
        time.sleep(3)
